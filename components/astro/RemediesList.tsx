              ...
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 mb-2">
                    <h4 className="font-semibold text-gray-900 text-sm sm:text-base">{remedy.title}</h4>
                    <span className="text-xs bg-primary-100 text-primary-700 px-2 py-1 rounded self-start">
                      {remedy.type}
                    </span>
                  </div>
                  <p className="text-sm text-gray-600 mb-2 leading-relaxed">{remedy.description}</p>
                  <div className="bg-gray-50 p-2 sm:p-3 rounded border border-gray-200">
                    <p className="text-sm font-medium text-gray-700 mb-1">Instructions:</p>
                    <p className="text-sm text-gray-600 mb-2 leading-relaxed">{remedy.instructions}</p>
